...
const buttonVariants = cva(
  "inline-flex uppercase items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-blue-dark-900 text-primary-foreground shadow hover:bg-blue-800",
        destructive:
          "bg-green-900 text-destructive-foreground shadow-sm hover:bg-green-900",
        outline:
          "border border-input bg-esmeralda shadow-sm hover:bg-accent hover:text-accent-foreground",
        secondary:
